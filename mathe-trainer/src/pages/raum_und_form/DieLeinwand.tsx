...
const exercises: Exercise[] = [
  ...
  {
    id: 6,
    question: "Beim orangen Dreieck sind folgende Maße gegeben: Strecke JK = 3,61 Meter, Strecke KL = 2 Meter. Berechne die Länge der Strecke JL. Der rechte Winkel liegt bei Punkt L.",
    expectedAnswer: 3.0,
    tolerance: 0.1,
    unit: "m",
    hint: "Mit einem rechten Winkel bei L nutzt du den Satz des Pythagoras: JL² = JK² - KL²",
    solution: [
      "Mit dem rechten Winkel bei Punkt L können wir den Satz des Pythagoras nutzen.",
