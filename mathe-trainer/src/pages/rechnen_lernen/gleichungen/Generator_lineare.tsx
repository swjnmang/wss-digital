...
const AUFGABEN_KATEGORIEN: Kategorie[] = [
  ...
  },
  {
    ...
    aufgaben: [
      ...
      { id: 'm21', aufgabe: '2x + 10 = 22x - 12', loesung: 1, rechenweg: ['2x + 10 = 22x - 12', '2x - 22x = -12 - 10   | -22x -10', '-20x = -22', '-20x = -22', 'x = 1.1  | : (-20)'] },
      ...
      { id: 'm27', aufgabe: '2(3x - 1) = 3(2x - 1) + 1', loesung: 2, rechenweg: ['2(3x - 1) = 3(2x - 1) + 1', '6x - 2 = 6x - 3 + 1   | Ausmultiplizieren', '6x - 2 = 6x - 2', 'Identität - alle x erfüllen  | -6x +2'] },
      ...
      { id: 'm34', aufgabe: '6(x + 1) - 4(x - 2) = 22', loesung: 3, rechenweg: ['6(x + 1) - 4(x - 2) = 22', '6x + 6 - 4x + 8 = 22   | Ausmultiplizieren', '2x + 14 = 22', '2x = 22 - 14', '2x = 8  | -14', '2x = 8', 'x = 4  | : 2'] },
      { id: 'm35', aufgabe: '3(2x - 4) = 18', loesung: 4, rechenweg: ['3(2x - 4) = 18', '6x - 12 = 18   | Ausmultiplizieren', '6x = 18 + 12', '6x = 30  | +12', '6x = 30', 'x = 5  | : 6'] },
      { id: 'm36', aufgabe: '4(x - 3) = 3(x - 2) + 2', loesung: 12, rechenweg: ['4(x - 3) = 3(x - 2) + 2', '4x - 12 = 3x - 6 + 2   | Ausmultiplizieren', '4x - 12 = 3x - 4', '4x - 3x = -4 + 12', 'x = 8  | -3x +12'] },
      { id: 'm37', aufgabe: '5(x - 2) + 3(x + 1) = 37', loesung: 6, rechenweg: ['5(x - 2) + 3(x + 1) = 37', '5x - 10 + 3x + 3 = 37   | Ausmultiplizieren', '8x - 7 = 37', '8x = 37 + 7', '8x = 44  | +7', '8x = 44', 'x = 5.5  | : 8'] },
      { id: 'm38', aufgabe: '2(3x + 4) - 3(x - 1) = 32', loesung: 6, rechenweg: ['2(3x + 4) - 3(x - 1) = 32', '6x + 8 - 3x + 3 = 32   | Ausmultiplizieren', '3x + 11 = 32', '3x = 32 - 11', '3x = 21  | -11', '3x = 21', 'x = 7  | : 3'] },
      ...
      { id: 'm40', aufgabe: '3(x + 4) + 2(x - 1) = 38', loesung: 6, rechenweg: ['3(x + 4) + 2(x - 1) = 38', '3x + 12 + 2x - 2 = 38   | Ausmultiplizieren', '5x + 10 = 38', '5x = 38 - 10', '5x = 28  | -10', '5x = 28', 'x = 5.6  | : 5'] },
  ...
  },
  {
    ...
    aufgaben: [
      ...
      { id: 's33', aufgabe: '2,5x - 3,4(2 - 3x) = x : 2 - 12,9', loesung: 1, rechenweg: ['2,5x - 3,4(2 - 3x) = x:2 - 12,9', '2,5x - 6,8 + 10,2x = 0,5x - 12,9   | Ausmultiplizieren', '12,7x - 6,8 = 0,5x - 12,9', '12,2x = -6,1', 'x = -0.5  | : 12,2'] },
      { id: 's34', aufgabe: '5.1 - (8x - 15) = 36x - (55 - (7x + 23) + 2x)', loesung: 2, rechenweg: ['5.1 - (8x - 15) = 36x - (55 - (7x + 23) + 2x)', '5.1 - 8x + 15 = 36x - (55 - 7x - 23 + 2x)   | Klammern lösen', '20.1 - 8x = 36x - (-7x + 32) ', '20.1 - 8x = 36x + 7x - 32', '20.1 - 8x = 43x - 32  | Vereinfachen', '-51x = -52.1', 'x ≈ 1.02  | +8x -20.1'] },
      ...
      { id: 's45', aufgabe: '5(4 - 2x) = x + 2', loesung: 0.727, rechenweg: ['5(4 - 2x) = x + 2', '20 - 10x = x + 2   | Ausmultiplizieren', '-11x = -18', 'x ≈ 1.636  | : (-11)'] },
      ...
      { id: 's48', aufgabe: '3(2x - 4) + 1 = 7(x - 1)', loesung: 2, rechenweg: ['3(2x - 4) + 1 = 7(x - 1)', '6x - 12 + 1 = 7x - 7   | Ausmultiplizieren', '6x - 11 = 7x - 7', '-x = 4', 'x = -4  | · (-1)'] },
      { id: 's49', aufgabe: '8x - 12 = 4x + 8', loesung: 5, rechenweg: ['8x - 12 = 4x + 8', '4x = 20   | -4x +12', 'x = 5  | : 4'] },
      { id: 's50', aufgabe: '5(x - 1) - 3(x - 2) = 8', loesung: 5.5, rechenweg: ['5(x - 1) - 3(x - 2) = 8', '5x - 5 - 3x + 6 = 8   | Ausmultiplizieren', '2x + 1 = 8', '2x = 7', 'x = 3.5  | : 2'] },
