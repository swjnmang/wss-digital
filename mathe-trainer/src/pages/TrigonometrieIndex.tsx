...
const subpages = [
  {
    title: '1. Winkelbeziehungen',
    description: 'Scheitel-, Neben-, Wechsel- und Stufenwinkel an sich schneidenden und parallelen Geraden erkennen.',
    icon: 'fa-solid fa-angles-up-down',
    path: '/trigonometrie/winkelbeziehungen',
  },
  {
    title: '2. Rechtwinklige Dreiecke beschriften',
    description: 'Hypotenuse, Gegenkathete und Ankathete korrekt zuordnen.',
    icon: 'fa-solid fa-shapes',
    path: '/trigonometrie/rechtwinklig-beschriften',
  },
  {
    title: '3. Sinus, Kosinus und Tangens erkennen',
  ...
  {
    title: '4. Streckenlänge mit Sinus, Kosinus und Tangens berechnen',
  ...
  {
    title: '5. Winkel berechnen mit Sinus, Kosinus und Tangens',
  ...
  {
    title: '6. Steigungswinkel in Prozent und Grad',
    description: 'Steigungsangaben zwischen Prozent und Winkelmaß umrechnen.',
    icon: 'fa-solid fa-mountain',
    path: '/trigonometrie/steigungswinkel-prozent-grad',
  },
  {
    title: '7. Sinussatz',
  ...
  {
    title: '11. Kosinusfunktion',
    description: 'Die Kosinusfunktion am Einheitskreis verstehen und ihren Funktionsgraphen erkunden.',
    icon: 'fa-solid fa-wave-square',
    path: '/trigonometrie/kosinusfunktion',
  },
  {
    title: '12. Gemischte Übungsaufgaben',
    description: 'Zufällig gemischte Aufgaben aus allen Themen (ohne Sinus-/Kosinusfunktion) üben.',
    icon: 'fa-solid fa-shuffle',
    path: '/trigonometrie/gemischte-uebungsaufgaben',
  },
  {
    title: '13. Anwendungsaufgaben',
    description: 'Praxisnahe Aufgaben aus dem Alltag Schritt für Schritt lösen.',
    icon: 'fa-solid fa-list-check',
    path: '/trigonometrie/anwendungsaufgaben',
  },
  {
    title: '14. Prüfungsmodus',
