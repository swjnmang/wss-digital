...
const RechtwinkligStrecken: React.FC = () => {
    ...
    const generateTask = () => {
        ...
        // Diese Seite fragt ausschließlich Streckenlängen ab
        const type: '2sides_1angle_side' = '2sides_1angle_side';
        ...
        <div className="container mx-auto px-4 py-8 max-w-4xl">
            <div className="bg-white rounded-xl shadow-lg p-6">
                <h1 className="text-3xl font-bold text-teal-800 text-center mb-6">
                    Streckenlänge mit Sinus, Kosinus und Tangens berechnen
                </h1>
...
export default RechtwinkligStrecken;
