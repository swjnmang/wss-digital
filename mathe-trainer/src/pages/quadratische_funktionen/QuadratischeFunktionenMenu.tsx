...
const menuItems = [
  ...
  {
    title: '3. Verschiebung der Normalparabel',
    description: 'Lerne, wie d und c die Normalparabel entlang der x- und y-Achse verschieben.',
    path: '/quadratische_funktionen/verschiebung_normalparabel',
    icon: 'fa-solid fa-arrows-up-down-left-right',
  },
  {
    title: '4. Scheitelpunkt ablesen',
