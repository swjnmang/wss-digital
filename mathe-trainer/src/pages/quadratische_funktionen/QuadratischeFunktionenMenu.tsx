...
const menuItems = [
  {
    title: '1. Wertetabellen erstellen',
    description: 'Erstelle oder vervollständige Wertetabellen für quadratische Funktionen.',
    path: '/quadratische_funktionen/wertetabelle',
    icon: 'fa-solid fa-table',
  },
  {
    title: '2. Normalparabel',
  ...
  {
    title: '7. Umwandlung in Scheitelform',
  ...
  {
    title: '8. Umwandlung in Allg. Form',
  ...
  {
    title: '9. Funktionsgleichung aufstellen',
