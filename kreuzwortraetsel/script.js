...
const ENTRIES = [
  { num: 1,  word: "SCHABLONE",        row: 2,  col: 7,  dir: "across" },
  { num: 2,  word: "FISCHE",           row: 2,  col: 22, dir: "down"   },
  { num: 3,  word: "WEGBIER",          row: 16, col: 7,  dir: "across" },
  { num: 4,  word: "CONTINENTAL",      row: 2,  col: 2,  dir: "down"   },
  { num: 5,  word: "MICHELBACH",       row: 3,  col: 0,  dir: "down"   },
  { num: 6,  word: "TAUCHEN",          row: 9,  col: 16, dir: "across" },
  { num: 7,  word: "PFARRHAUS",        row: 10, col: 6,  dir: "across" },
  { num: 8,  word: "INNENVERTEIDIGER", row: 4,  col: 0,  dir: "across" },
  { num: 9,  word: "CATWALKBANGER",    row: 2,  col: 8,  dir: "down"   },
  { num: 10, word: "JESSICA",          row: 5,  col: 17, dir: "across" },
  { num: 11, word: "NUERNBERG",        row: 9,  col: 13, dir: "down"   },
  { num: 12, word: "NIKLAS",           row: 0,  col: 20, dir: "down"   },
  { num: 13, word: "KROATIEN",         row: 12, col: 12, dir: "across" },
  { num: 14, word: "ERDKUNDE",         row: 5,  col: 18, dir: "down"   },
  { num: 15, word: "KAISERBURG",       row: 6,  col: 7,  dir: "across" },
  { num: 16, word: "LEBKUCHEN",        row: 14, col: 11, dir: "across" },
  { num: 17, word: "WOHNSITUATION",    row: 1,  col: 4,  dir: "down"   },
];
