...
export default function BeruflicheMoeglichkeiten() {
              ...
              <div className="grid grid-cols-[repeat(auto-fit,minmax(240px,1fr))] gap-6">
                {[1, 2, 3].map((i) => (
                  <div key={i} className="bg-slate-50 rounded-xl p-6 border border-slate-200">
                    ...
                    <p className="text-slate-600 text-sm mb-4">Erkunde verschiedene Karriereoptionen...</p>
          ...
          {activeTab === 'texte' && (
            <div>
              ...
              <div className="bg-slate-50 rounded-xl p-8 border border-slate-200">
                <h3 className="text-xl font-semibold text-slate-900 mb-4">Karrieremöglichkeiten in Gamification und Game Design</h3>
                <p className="text-slate-700 mb-4 leading-relaxed">
                  Die Gamification-Industrie wächst rasant. Es gibt Möglichkeiten als Game Designer, UX Designer, Programmer, Producer oder Creative Director zu arbeiten.
                </p>
                <p className="text-slate-700 leading-relaxed">
                  Du kannst in Unternehmen, Bildungseinrichtungen, oder als Freelancer arbeiten. Besonders im Bereich E-Learning, Unternehmensschulung und Entertainment sind Fachkräfte gefragt.
                </p>
              </div>
            </div>
          )}
              ...
              <div className="grid grid-cols-[repeat(auto-fit,minmax(240px,1fr))] gap-6">
                {[1, 2].map((i) => (
                  <div key={i} className="bg-slate-50 rounded-xl p-6 border border-slate-200">
                    ...
                    <p className="text-slate-600 text-sm mb-4">Erstelle ein Bewerbungsprofil mit deinen Skills...</p>
