...
export default function Fit4Finance() {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      <header className="bg-gradient-to-br from-slate-800 to-slate-700 text-white py-12 px-4 text-center shadow-md relative">
        ...
        <h1 className="text-4xl font-bold mb-2 tracking-tight">Fit4Finance</h1>
        <p className="text-lg text-slate-300">Deine finanziellen Fähigkeiten trainieren</p>
      </header>
              ...
              <div className="grid grid-cols-[repeat(auto-fit,minmax(240px,1fr))] gap-6">
                {[1, 2, 3].map((i) => (
                  <div key={i} className="bg-slate-50 rounded-xl p-6 border border-slate-200">
                    ...
                    <p className="text-slate-600 text-sm mb-4">Finanzielle Fähigkeiten trainieren...</p>
          ...
          {activeTab === 'texte' && (
            <div>
              ...
              <div className="bg-slate-50 rounded-xl p-8 border border-slate-200">
                <h3 className="text-xl font-semibold text-slate-900 mb-4">Finanzkompetenz für die Zukunft</h3>
                <p className="text-slate-700 mb-4 leading-relaxed">
                  Finanzielle Bildung ist essentiell für ein selbstbestimmtes Leben. In diesem Modul lernst du die Grundlagen von Sparen, Investieren und persönlichem Finanzmanagement.
                </p>
                <p className="text-slate-700 leading-relaxed">
                  Von Budgetplanung bis zur Altersvorsorge - alles, was du brauchst, um finanziell fit zu sein.
                </p>
              </div>
            </div>
          )}
              ...
              <div className="grid grid-cols-[repeat(auto-fit,minmax(240px,1fr))] gap-6">
                {[1, 2].map((i) => (
                  <div key={i} className="bg-slate-50 rounded-xl p-6 border border-slate-200">
                    ...
                    <p className="text-slate-600 text-sm mb-4">Praktische Finanzen-Aufgaben...</p>
