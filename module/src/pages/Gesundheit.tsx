  ...
  return (
    <div className="min-h-screen flex flex-col">
      <header className="bg-gradient-to-br from-slate-800 to-slate-700 text-white py-12 px-4 text-center shadow-md relative">
        ...
        <h1 className="text-4xl font-bold mb-2 tracking-tight">⚕️ Gesundheit</h1>
        <p className="text-lg text-slate-300">Wirtschaft im Gesundheitswesen verstehen</p>
      </header>
              ...
              <div className="grid grid-cols-[repeat(auto-fit,minmax(240px,1fr))] gap-6">
                {[1, 2, 3].map((i) => (
                  <div key={i} className="bg-slate-50 rounded-xl p-6 border border-slate-200">
                    ...
                    <p className="text-slate-600 text-sm mb-4">Verständnis für Gesundheitssystem...</p>
          ...
          {activeTab === 'texte' && (
            <div>
              ...
              <div className="bg-slate-50 rounded-xl p-8 border border-slate-200">
                <h3 className="text-xl font-semibold text-slate-900 mb-4">Wirtschaft im Gesundheitswesen</h3>
                <p className="text-slate-700 mb-4 leading-relaxed">
                  Das Gesundheitssystem ist ein komplexes Netzwerk von Organisationen, die Gesundheitsdienstleistungen erbringen. Wirtschaftliche Prinzipien spielen eine wichtige Rolle in der Effizienz und Qualität der Versorgung.
                </p>
                <p className="text-slate-700 leading-relaxed">
                  Verstehe die Kosten-Nutzen-Analysen, Finanzierung und Management von Gesundheitseinrichtungen.
                </p>
              </div>
            </div>
          )}
              ...
              <div className="grid grid-cols-[repeat(auto-fit,minmax(240px,1fr))] gap-6">
                {[1, 2].map((i) => (
                  <div key={i} className="bg-slate-50 rounded-xl p-6 border border-slate-200">
                    ...
                    <p className="text-slate-600 text-sm mb-4">Praktische Übung zu Gesundheitsthemen...</p>
